...
const AdminPdfConfigPage: React.FC = () => {
  const { pdfConfig, updatePdfConfig, isLoading: isLoadingContent } = useEditableContent();
  ...
  const logoPreviewUrl = currentConfig.logoId ? mediaItems.find(item => item.id === currentConfig.logoId)?.dataUrl : null;
