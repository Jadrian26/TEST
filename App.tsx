...
import AdminEditUserPage from './pages/admin/AdminEditUserPage'; // New User Edit Page
...
import AdminPdfConfigPage from './pages/admin/AdminPdfConfigPage';
          ...
          <main className="flex-grow container mx-auto px-4 py-8">
            ...
            <Routes>
              ...
              <Route path="/admin" element={<AdminProtectedRoute><AdminLayout /></AdminProtectedRoute>}>
                ...
                <Route path="usuarios/editar/:userId" element={<AdminEditUserPage />} /> {/* New Route */}
                <Route path="pedidos" element={<AdminViewOrdersPage />} />
                <Route path="pdf-config" element={<AdminPdfConfigPage />} />
              </Route>
